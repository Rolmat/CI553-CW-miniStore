...
public class CashierView implements Observer
{
  ...
  public CashierView(  RootPaneContainer rpc,  MiddleFactory mf, int x, int y  )
  {
    ...
    buyQuantity.setBounds( 330, 50, 40, 40 );         // Quantity Area
    buyQuantity.setText("1");                           // set to 1 for default quantity
    buyQuantity.setHorizontalAlignment(JTextField.CENTER);//Center text
  ...
  public void update( Observable modelC, Object arg )
  {
    ...
    if(message.equals("!!! Not in stock")||message.contains("Purchased ")){
      buyQuantity.setText("1");   //reset quantity to 1
    }
  }
